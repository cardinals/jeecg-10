...
function loadTree() {	
	jQuery.ajax({  
        ...
        type: 'POST',  
        dataType : "json",  
        url: 'wuyeYzglFwqrglController.do?getTreeData', //请求的action路径  
	...
	var ztreeCreator = new ZtreeCreator('orgTree',"wuyeYzglFwqrglController.do?getTreeData",zNodes)
...
function zTreeOnLeftClick(event, treeId, treeNode) {
	...
	var url = "wuyeYzglFwqrglController.do?list&id=" + curSelectNode.id+"&parentId="+curSelectNode.parentId;
