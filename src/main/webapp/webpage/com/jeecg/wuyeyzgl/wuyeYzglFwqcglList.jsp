...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wuyeFwxxList" checkbox="true" pagination="true" fitColumns="false" title="房屋基本信息" actionUrl="wuyeYzglFwqcglController.do?datagrid" idField="id" fit="true" queryMode="group"  sortName="fjbh">
   ...
   <t:dgToolBar title="迁出" icon="icon-edit" url="wuyeYzglFwqcglController.do?goUpdate" funname="update" width="780"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
