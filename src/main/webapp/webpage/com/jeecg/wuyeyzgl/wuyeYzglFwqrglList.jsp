...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wuyeFwxxList" checkbox="true" pagination="true" fitColumns="false" title="房屋基本信息" actionUrl="wuyeYzglFwqrglController.do?datagrid" idField="id" fit="true" queryMode="group" sortName="fjbh" >
   ...
   <t:dgCol title="房间ID"  field="fjid"  queryMode="single"  width="120"  hidden="true" ></t:dgCol>
   ...
   <t:dgCol title="总楼层数"  field="zlcs"  queryMode="group"  width="120" hidden="true" ></t:dgCol>
   <t:dgCol title="单元号"  field="dyh"  queryMode="group"  width="120" hidden="true" ></t:dgCol>
   <t:dgCol title="楼层号"  field="lch"  queryMode="group"  width="120" hidden="true" ></t:dgCol>
   ...
   <t:dgCol title="建筑面积"  field="jzmj"   queryMode="group"  width="120" ></t:dgCol>
   <t:dgCol title="套内面积"  field="tnmj"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="公摊面积"  field="gtmj"  queryMode="group"  width="120" hidden="true" ></t:dgCol>
   <t:dgCol title="阳台面积"  field="ytmj"  queryMode="group"  width="120" hidden="true" ></t:dgCol>
   ...
   <t:dgCol title="房屋状态"  field="fwzt"   queryMode="single"  dictionary="fwzt"  width="120"></t:dgCol>
   <%--<t:dgCol title="竣工日期"  field="jgrq"  formatter="yyyy-MM-dd"  queryMode="single"  width="120" hidden="true" ></t:dgCol>
   <t:dgCol title="交房日期"  field="jfrq"  formatter="yyyy-MM-dd"  queryMode="single"  width="120" hidden="true" ></t:dgCol>
   <t:dgCol title="装修日期"  field="zxrq"  formatter="yyyy-MM-dd"  queryMode="single"  width="120" hidden="true" ></t:dgCol>
   <t:dgCol title="入住日期"  field="rzrq"  formatter="yyyy-MM-dd"  queryMode="single"  width="120" hidden="true" ></t:dgCol> --%>
   ...
   <t:dgCol title="证件类型"  field="zjmc"  queryMode="single"  dictionary="zjlx"  width="120" hidden="true" ></t:dgCol>
   ...
   <t:dgToolBar title="迁入" icon="icon-edit" url="wuyeYzglFwqrglController.do?goUpdate" funname="update" width="780"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
 <script src = "webpage/com/jeecg/wuyeyzgl/wuyeYzglFwqrglList.js"></script>		
