			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<t:dictSelect field="sffwdx" type="list" extendJson="{class:'form-control'}"   typeGroupCode="sfdx"  hasLabel="false"  title="迁出后收费服务对象"></t:dictSelect>     
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<t:dictSelect field="qrhfjzt" type="list" extendJson="{class:'form-control'}"   typeGroupCode="fwzt"  hasLabel="false"  title="迁出后房间状态"></t:dictSelect>     
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
