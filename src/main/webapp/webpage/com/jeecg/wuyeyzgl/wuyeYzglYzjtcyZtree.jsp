...
function loadTree() {	
	jQuery.ajax({  
        ...
        type: 'POST',  
        dataType : "json",  
        url: 'wuyeYzglYzjtcyController.do?getTreeData', //请求的action路径  
	...
	var ztreeCreator = new ZtreeCreator('orgTree',"wuyeYzglYzjtcyController.do?getTreeData",zNodes)
...
function zTreeOnLeftClick(event, treeId, treeNode) {
	...
	var url = "wuyeYzglYzjtcyController.do?list1&id=" + curSelectNode.id;
