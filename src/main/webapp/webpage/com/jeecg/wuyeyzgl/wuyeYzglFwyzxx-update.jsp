...
<style type="text/css">
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wuyeYzglFwyzxxController.do?doUpdate" tiptype="1" >
			...
			<input type="hidden" id="fwyzid" name="id" value='${wuyeYzglFwyzxxPage.id}' >
						...
						<div class="yzxx">
							...
							<div class="row show-grid">
						   	...
						   	<div class="row show-grid">    
						          ...
						          <div class="col-xs-3">
									<t:dictSelect  extendJson="{class:'form-control'}"  field="yzXb" typeGroupCode="sex" type="select" defaultVal="${wuyeYzglFwyzxxPage.yzXb}"></t:dictSelect>
									<span class="Validform_checktip" style="float:left;height:0px;"></span>
						...
						<div class="dkrxx" style="display:none">
							...
							<div class="row show-grid">
						          ...
						          <div class="col-xs-3">
									...
									<t:dictSelect extendJson="{class:'form-control'}" field="dkrDkdw" typeGroupCode="dkrDkdw" type="select" defaultVal="${wuyeYzglFwyzxxPage.dkrDkdw}"></t:dictSelect>
									<span class="Validform_checktip" style="float:left;height:0px;"></span>
						...
						<div class="qtxx" style="display:none">     
							<div class="row show-grid">
						          ...
						          <div class="col-xs-3">
									...
									<t:dictSelect extendJson="{class:'form-control'}" field="jmyy" typeGroupCode="jmyy" type="select" defaultVal="${wuyeYzglFwyzxxPage.jmyy}"></t:dictSelect>
									<span class="Validform_checktip" style="float:left;height:0px;"></span>
									<label class="Validform_label" style="display: none">减免类型</label>
						          </div>
							</div>
...
<script type="text/javascript">
  ...
  //代扣银行账号验证
  $("#dkrDkyhzh").on("blur",function(){
		var value = $(this).val();
		var fwyzid = $("#fwyzid").val();
		if(value == ""){
			layer.msg("银行账号不能为空！")
		}else{
			$.post('wuyeYzglFwyzxxController.do?existence',{yhzh:value,fwyzid:fwyzid},function(data){
				if(data == "err"){
					$("#dkrDkyhzh").val("");
					layer.msg("银行账号已经存在，重新输入！")
				}
			}) 
		}
	})
