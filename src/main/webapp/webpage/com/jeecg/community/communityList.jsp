...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="communityList" checkbox="true" pagination="true" fitColumns="true" title="小区表" actionUrl="communityController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="小区名称"  field="commName"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="所属管区id"  field="managerAreaid"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   <t:dgDelOpt title="删除" url="communityController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="communityController.do?goAdd" funname="add"  width="768"></t:dgToolBar>
