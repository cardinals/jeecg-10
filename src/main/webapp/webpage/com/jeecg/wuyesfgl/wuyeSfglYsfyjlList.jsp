...
<div class="easyui-layout" id="vvv" fit="true">
  ...
  <t:datagrid name="wuyeSfglYsfyjlList" checkbox="true" pagination="false" fitColumns="false" title="应收费用审核" actionUrl="wuyeSfglYsfyjlController.do?datagrid&lyid=${lyid}" idField="id" fit="true" queryMode="group">
  ...
  <%--  <t:dgToolBar title="删除"  icon="icon-remove" url="wuyeSfglYsfyjlController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar> --%>
