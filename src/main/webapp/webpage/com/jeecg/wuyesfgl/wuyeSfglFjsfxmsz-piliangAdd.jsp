...
<body>
		...
		<div class="tab-wrapper">
			...
			<ul class="nav nav-tabs">
				<li role="presentation" class="active"><a
					href="javascript:void(0);">收费项目批量录入</a></li>
			</ul>
			<!-- tab内容 -->
			<div class="con-wrapper" id="con-wrapper1" style="display: block;">
				<div class="row form-wrapper">
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="doSUbBtn" type="button" onclick="doSubmit()" value="　点击提交　" class="btn btn-default">
						</div>
					</div>
	...
	<script type="text/javascript">
		...
		function doSubmit() {
			...
			$('#addform').form('submit', {    
			    url:"wuyeSfglFjsfxmszPiliangController.do?doAdd",    
