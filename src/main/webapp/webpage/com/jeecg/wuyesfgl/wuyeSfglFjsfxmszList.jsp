...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wuyeSfglFjsfxmszList" checkbox="true" pagination="true" fitColumns="true" title="房间收费项目设置" actionUrl="wuyeSfglFjsfxmszController.do?datagrid&fjid=${fjid}" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="是否收费" dictionary="cfcz" hidden="true" field="sfbz"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgToolBar title="批量录入" icon="icon-add" url="wuyeSfglFjsfxmszPiliangController.do?PiliangList&doid=add" funname="addAndUpdate"></t:dgToolBar>
   <t:dgToolBar title="批量编辑" icon="icon-edit" url="wuyeSfglFjsfxmszPiliangController.do?PiliangList&doid=update" funname="addAndUpdate"></t:dgToolBar>
