...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wuyeCbglFjbList" checkbox="true" pagination="true" fitColumns="true" title="房间表管理" actionUrl="wuyeCbglFjbController.do?datagrid_ly" idField="id" fit="true" queryMode="group">
