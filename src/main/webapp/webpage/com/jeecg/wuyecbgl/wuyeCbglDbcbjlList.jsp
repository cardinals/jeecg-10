...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wuyeCbglDbcbjlList" checkbox="true" pagination="true" fitColumns="true" title="电表抄表记录" actionUrl="wuyeCbglDbcbjlController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="wuyeCbglDbcbjlController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="wuyeCbglDbcbjlController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="wuyeCbglDbcbjlController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="wuyeCbglDbcbjlController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="wuyeCbglDbcbjlController.do?goUpdate" funname="detail"></t:dgToolBar>
 ...
 <script src = "webpage/com/jeecg/wuyecbgl/wuyeCbglDbcbjlList.js"></script>		
 <script type="text/javascript">
 $(document).ready(function(){
 });
 
 function dcScmb(){
	  JeecgExcelExport("wuyeCbglDbcbjlController.do?dcscmb","wuyeCbglDbcbjlList");
 }

 function drScmb(){
	  openuploadwin('Excel导入', "wuyeCbglDbcbjlController.do?upload1","wuyeCbglDbcbjlList");
 }
 
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'wuyeCbglDbcbjlController.do?upload', "wuyeCbglDbcbjlList");
}

//导出
function ExportXls() {
	JeecgExcelExport("wuyeCbglDbcbjlController.do?exportXls","wuyeCbglDbcbjlList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("wuyeCbglDbcbjlController.do?exportXlsByT","wuyeCbglDbcbjlList");
}
