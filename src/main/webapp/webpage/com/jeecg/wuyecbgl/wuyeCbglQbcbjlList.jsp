...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wuyeCbglQbcbjlList" checkbox="true" pagination="true" fitColumns="true" title="气表抄表记录" actionUrl="wuyeCbglQbcbjlController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="wuyeCbglQbcbjlController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="wuyeCbglQbcbjlController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="wuyeCbglQbcbjlController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="wuyeCbglQbcbjlController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="wuyeCbglQbcbjlController.do?goUpdate" funname="detail"></t:dgToolBar>
 ...
 <script src = "webpage/com/jeecg/wuyecbgl/wuyeCbglQbcbjlList.js"></script>		
 <script type="text/javascript">
 $(document).ready(function(){
 });
 
 function dcScmb(){
	  JeecgExcelExport("wuyeCbglQbcbjlController.do?dcscmb","wuyeCbglQbcbjlList");
 }

 function drScmb(){
	  openuploadwin('Excel导入', "wuyeCbglQbcbjlController.do?upload1","wuyeCbglQbcbjlList");
 }
 
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'wuyeCbglQbcbjlController.do?upload', "wuyeCbglQbcbjlList");
}

//导出
function ExportXls() {
	JeecgExcelExport("wuyeCbglQbcbjlController.do?exportXls","wuyeCbglQbcbjlList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("wuyeCbglQbcbjlController.do?exportXlsByT","wuyeCbglQbcbjlList");
}
