...
function loadTree() {	
	jQuery.ajax({  
        ...
        type: 'POST',  
        dataType : "json",  
        url: 'wuyeCbglDbcbjlController.do?getTreeData1', //请求的action路径  
	...
	var ztreeCreator = new ZtreeCreator('orgTree',"wuyeCbglDbcbjlController.do?getTreeData1",zNodes)
...
function zTreeOnLeftClick(event, treeId, treeNode) {
	...
	var url = "wuyeCbglDbcbjlController.do?list&id=" + curSelectNode.id;
