...
function loadTree() {	
	jQuery.ajax({  
        ...
        type: 'POST',  
        dataType : "json",  
        url: 'wuyeCbglGtbController.do?getTreeData', //请求的action路径  
	...
	var ztreeCreator = new ZtreeCreator('orgTree',"wuyeCbglGtbController.do?getTreeData",zNodes)
...
function zTreeOnLeftClick(event, treeId, treeNode) {
	...
	var url = "wuyeCbglGtbController.do?list_ly&id=" + curSelectNode.id;
