...
function loadTree() {	
	jQuery.ajax({  
        ...
        type: 'POST',  
        dataType : "json",  
        url: 'wuyeCbglSbcbjlController.do?getTreeData1', //请求的action路径  
	...
	var ztreeCreator = new ZtreeCreator('orgTree',"wuyeCbglSbcbjlController.do?getTreeData1",zNodes)
...
function zTreeOnLeftClick(event, treeId, treeNode) {
	...
	var url = "wuyeCbglSbcbjlController.do?list&id=" + curSelectNode.id;
