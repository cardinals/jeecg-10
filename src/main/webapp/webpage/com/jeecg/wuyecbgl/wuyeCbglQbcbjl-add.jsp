 ...
 <body>
   	<div class="easyui-layout" fit="true" scroll="no">
		...
		<div data-options="region:'center',border:false" style="text-align: center;">
			 <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wuyeCbglQbcbjlController.do?doAdd" >
		...
		$("select#ybbh").change(function(){
	 		 if($('#ybbh option:selected').text()!="-- 请选择 -- "){				
	 			 $.ajax({
	 		        type: 'POST',  
	 		        dataType : "json",  
	 		        url: 'wuyeCbglQbcbjlController.do?getYbxx',
...
function loadTree() {	
	jQuery.ajax({  
        ...
        type: 'POST',  
        dataType : "json",  
        url: 'wuyeCbglQbcbjlController.do?getTreeData', //请求的action路径  
	...
	var ztreeCreator = new ZtreeCreator('orgTree',"wuyeCbglQbcbjlController.do?getTreeData",zNodes)
...
function zTreeOnLeftClick(event, treeId, treeNode) {
	...
	if(treeNode.glqlx != '1' && treeNode.glqlx != '2' && treeNode.glqlx != '3' && treeNode.glqlx != '4'){
		...
		$.ajax({
	        type: 'POST',  
	        dataType : "json",  
	        url: 'wuyeCbglQbcbjlController.do?getYbbh',
	        data:'fjid='+parentId,
	        success:function(data){	        	
