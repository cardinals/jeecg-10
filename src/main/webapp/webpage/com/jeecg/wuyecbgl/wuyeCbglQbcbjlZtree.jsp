...
function loadTree() {	
	jQuery.ajax({  
        ...
        type: 'POST',  
        dataType : "json",  
        url: 'wuyeCbglQbcbjlController.do?getTreeData1', //请求的action路径  
	...
	var ztreeCreator = new ZtreeCreator('orgTree',"wuyeCbglQbcbjlController.do?getTreeData1",zNodes)
...
function zTreeOnLeftClick(event, treeId, treeNode) {
	...
	var url = "wuyeCbglQbcbjlController.do?list&id=" + curSelectNode.id;
