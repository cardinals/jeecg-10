...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="buildingList" checkbox="true" pagination="true" fitColumns="true" title="楼宇表" actionUrl="buildingController.do?datagrid" idField="id" sortName="createDate" fit="true" queryMode="group">
   ...
   <t:dgCol title="所属小区id"  field="commId"  query="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="所属管区id"  field="manaId"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="所属公司id"  field="comId"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="buildingController.do?goAdd" funname="add"  width="800" height="500"></t:dgToolBar>
