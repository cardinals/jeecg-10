...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="managerareaController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="areaName" name="areaName" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入管区名称"  datatype="*"  ignore="checked" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="areaAddress" name="areaAddress" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入管区地址"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="areaMan" name="areaMan" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入管区负责人"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="areaPhone" name="areaPhone" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入联系电话"  datatype="m" ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			<label for="fatherId" class="col-sm-3 control-label">所属公司：</label>
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="fatherId" name="fatherId" type="text" maxlength="36" value="${fatherId}"  ignore="ignore" style="display:none;"/>
