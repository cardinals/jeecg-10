...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wuyeYzglFwyzxxList" checkbox="true" pagination="true" fitColumns="false" title="添加租户" actionUrl="wuyeZhglFwztController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="完善信息" icon="icon-edit" url="wuyeZhglFwztController.do?goUpdate" funname="update" width="750"></t:dgToolBar>
