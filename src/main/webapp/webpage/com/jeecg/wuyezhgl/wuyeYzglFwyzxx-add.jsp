...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="wuyeZhglFwztController.do?doAdd" tiptype="1">
		...
		<div class="tab-wrapper">
			...
			<div class="con-wrapper" id="con-wrapper1" style="display: block;">
				...
				<!-- 业主信息================================================================================== -->
					<div class="yzxx">
						<div class="row show-grid"  hidden="hidden">
							<div class="col-xs-3 text-center">
								<b>管理区id：</b>
							</div>
							<div class="col-xs-3">
								 <input readonly="readonly" id="glqid" name="glqid" type="text" class="form-control" ignore="ignore"  value="${glqid}"/>
							...
							<div class="col-xs-3">
								<input readonly="readonly" id="fwxxid" name="fwxxid" type="text" class="form-control"
									ignore="ignore"  value="${fwxxid}"/> <span class="Validform_checktip"
						...
						<div class="row show-grid">
							...
							<div class="col-xs-3">
								<input readonly="readonly" id="fjid" name="fjid" type="text" class="form-control" datatype="n" ignore="ignore"  value="${fjid}"/> <span
							...
							<div class="col-xs-3">
									<input readonly="readonly" id="yzBm" name="yzBm"  type="text" class="form-control" ignore="ignore"  value="${yzbm}"/> 
						...
						<div class="row show-grid">
							...
							<div class="col-xs-3">	
								<t:dictSelect readonly="readonly"  field="syzSx" type="list" extendJson="{class:'form-control'}"   typeGroupCode="yzSx"  hasLabel="false"  title="业主属性"  dictText="zh" defaultVal="${yzsx}"></t:dictSelect>						
								<input hidden="hidden" id="yzSx"  name="yzSx"  class="form-control" ignore="ignore"  value="${yzsx}">
								<span class="Validform_checktip" style="float: left; height: 0px;"></span> 
							...
							<div class="col-xs-3" style="display: none">
									<t:dictSelect extendJson="{class:'form-control'}"  field="yzLx" typeGroupCode="yzLx" type="select"></t:dictSelect>
