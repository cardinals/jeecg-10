...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wuyeYzglFwyzxxList" checkbox="true" pagination="true" fitColumns="false" title="租户查询" actionUrl="wuyeZhglFwztController.do?datagridTwo" idField="id" fit="true" queryMode="group">
  
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="管理区id"  field="glqid" hidden="true"    width="120"></t:dgCol>
   ...
   <t:dgCol title="房间ID"  field="fjid"  queryMode="single"  width="120"></t:dgCol>
    <t:dgCol title="业主编码"  field="yzBm"  queryMode="single"  width="120" ></t:dgCol>
   <t:dgCol title="业主属性"  field="yzSx"  queryMode="single"  width="120"  dictionary="yzSx"></t:dgCol>
   <%-- <t:dgCol title="业主类型"  field="yzLx"  queryMode="single"  width="120"></t:dgCol> --%>
   ...
   <t:dgCol title="性别"  field="yzXb"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="出生日期"  field="yzCsrq"  queryMode="single"  width="120"  formatter="yyyy-MM-dd" ></t:dgCol>
   ...
   <t:dgCol title="租赁费"  field="zlf"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="代扣人工作单位"  field="dkrGzdw"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="代扣方式"  field="dkrDkfs"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="代扣银行"  field="dkrDkyh"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="代扣银行账号"  field="dkrDkyhzh"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="代扣单位"  field="dkrDkdw"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="减免原因"  field="jmyy"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="收费开始日期"  field="sfksrq"  queryMode="single"  width="120" formatter="yyyy-MM-dd" ></t:dgCol>
   ...
   <t:dgDelOpt title="删除" url="wuyeZhglFwztController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <%-- <t:dgToolBar title="添加租户" icon="icon-add" url="wuyeZhglFwztController.do?goAdd" funname="add"></t:dgToolBar> --%>
   <t:dgToolBar title="完善信息" icon="icon-edit" url="wuyeYzglFwyzxxController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="wuyeZhglFwztController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
