...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ywGuanliquyuController.do?doUpdate" >
					<input id="id" name="id" type="hidden" value="${ywGuanliquyuPage.id }"/>
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${ywGuanliquyuPage.name}'/>
					...
					<tr>
						...
						<td class="value">
							...
							value='${ywGuanliquyuPage.parentid}'
							data-options="
				                    panelHeight:'220',
				                    url: 'ywGuanliquyuController.do?datagrid&field=id,name',  
  ...
  <script src = "webpage/com/jeecg/guanliquyu/ywGuanliquyu.js"></script>		
