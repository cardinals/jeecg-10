...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="wuyeFwxxController.do?doUpdate" tiptype="1">
		<input type="hidden" id="btn_sub" class="btn_sub" />
		<input type="hidden" name="id" value='${wuyeFwxxPage.id}'>
			...
			<div class="con-wrapper" id="con-wrapper1" style="display: block;">
				<div class="row form-wrapper">
					<div class="row show-grid" >
						...
						<div class="col-xs-3">
							<input id="fjid" name="fjid" type="text" class="form-control"
								ignore="ignore" value='${wuyeFwxxPage.fjid}' /> <span
						...
						<div class="col-xs-3">
							<input id="glqid" name="glqid" type="text" class="form-control"
								ignore="ignore" value='${wuyeFwxxPage.glqid}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3" style="display: none">
							<input id="lyid" name="lyid" type="text" class="form-control"
								ignore="ignore" value='${wuyeFwxxPage.lyid}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
						...
						<div class="col-xs-3">
							<input id="zlcs" name="zlcs" type="text" class="form-control"
								datatype="n" ignore="ignore" value='${wuyeFwxxPage.zlcs}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
						...
						<div class="col-xs-3">
							<input id="lch" name="lch" type="text" class="form-control"
								datatype="n" ignore="ignore" value='${wuyeFwxxPage.lch}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="dyh" name="dyh" type="text" class="form-control"
								ignore="ignore" value='${wuyeFwxxPage.dyh}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
							<label class="Validform_label" style="display: none">单元号</label>
						</div>
						...
						<div class="col-xs-3">
							<input id="fjbh" name="fjbh" type="text" class="form-control"
								ignore="ignore" value='${wuyeFwxxPage.fjbh}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<t:dictSelect field="sffwdx" type="list"
								...
								hasLabel="false" title="收费服务对象"
								defaultVal="${wuyeFwxxPage.sffwdx}"></t:dictSelect>
						...
						<div class="col-xs-3">
							<t:dictSelect field="loux" type="list"
								...
								defaultVal="${wuyeFwxxPage.loux}" hasLabel="false" title="楼型"></t:dictSelect>
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<t:dictSelect field="fwhx" type="list"
								...
								hasLabel="false" title="房屋户型" defaultVal="${wuyeFwxxPage.fwhx}"></t:dictSelect>
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
						...
						<div class="col-xs-3">
							<t:dictSelect field="fwlx" type="list"
								...
								defaultVal="${wuyeFwxxPage.fwlx}" hasLabel="false" title="房屋类型"></t:dictSelect>
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<t:dictSelect field="zflb" type="list"
								...
								defaultVal="${wuyeFwxxPage.zflb}" hasLabel="false" title="住房类别"></t:dictSelect>
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
						...
						<div class="col-xs-3">
							<input id="fwyt" name="fwyt" type="text" class="form-control"
								ignore="ignore" value='${wuyeFwxxPage.fwyt}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
							<label class="Validform_label" style="display: none">房屋用途</label>
						</div>
					</div>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="fwcx" name="fwcx" type="text" class="form-control"
								ignore="ignore" value='${wuyeFwxxPage.fwcx}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
						...
						<div class="col-xs-3" style="display: none">
							<t:dictSelect field="fwzt"  type="list"
								...
								defaultVal="${wuyeFwxxPage.fwzt}" hasLabel="false" title="房屋状态"  ></t:dictSelect>
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="jgrq" name="jgrq" type="text"
								...
								value='<fmt:formatDate value='${wuyeFwxxPage.jgrq}' type="date" pattern="yyyy-MM-dd"/>' />
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
								class="Validform_label" style="display: none">竣工日期</label>
						</div>
						...
						<div class="col-xs-3">
							<input id="jfrq" name="jfrq" type="text"
								style="background: url('plug-in/ace/images/datetime.png') no-repeat scroll right center transparent;"
								class="form-control" onClick="WdatePicker()" ignore="ignore"
								value='<fmt:formatDate value='${wuyeFwxxPage.jfrq}' type="date" pattern="yyyy-MM-dd"/>' />
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
								class="Validform_label" style="display: none">交房日期</label>
						</div>
					</div>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="zxrq" name="zxrq" type="text"
								style="background: url('plug-in/ace/images/datetime.png') no-repeat scroll right center transparent;"
								class="form-control" onClick="WdatePicker()" ignore="ignore"
								value='<fmt:formatDate value='${wuyeFwxxPage.zxrq}' type="date" pattern="yyyy-MM-dd"/>' />
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
								class="Validform_label" style="display: none">装修日期</label>
						</div>
						...
						<div class="col-xs-3">
							<input id="rzrq" name="rzrq" type="text"
								style="background: url('plug-in/ace/images/datetime.png') no-repeat scroll right center transparent;"
								class="form-control" onClick="WdatePicker()" ignore="ignore"
								value='<fmt:formatDate value='${wuyeFwxxPage.rzrq}' type="date" pattern="yyyy-MM-dd"/>' />
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
								class="Validform_label" style="display: none">入住日期</label>
						</div>
					</div>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="fwcqr" name="fwcqr" type="text" class="form-control"
								ignore="ignore" value='${wuyeFwxxPage.fwcqr}'  disabled="disabled"/> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
							<label class="Validform_label" style="display: none">产权人</label>
						</div>
						...
						<div class="col-xs-3">
							<input id="cqrzjlx" name="cqrzjlx" type="text"
								...
								value='${wuyeFwxxPage.cqrzjlx}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="cqrzjhm" name="cqrzjhm" type="text"
								class="form-control" ignore="ignore"
								value='${wuyeFwxxPage.cqrzjhm}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
						...
						<div class="col-xs-3">
							<t:dictSelect field="cfczbz" type="list"
								...
								hasLabel="false" title="是否拆分出租"
								defaultVal="${wuyeFwxxPage.cfczbz}"></t:dictSelect>
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
					...
					<div class="row show-grid" style="display: none">
						...
						<div class="col-xs-3">
							<input id="pxh" name="pxh" type="text" class="form-control"
								datatype="n" ignore="ignore" value='${wuyeFwxxPage.pxh}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
						...
						<div class="col-xs-3">
							<input id="yxbz" name="yxbz" type="text" class="form-control"
								ignore="ignore" value='${wuyeFwxxPage.yxbz}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
