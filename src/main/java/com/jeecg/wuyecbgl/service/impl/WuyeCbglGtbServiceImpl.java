...
@Service("wuyeCbglGtbService")
@Transactional
public class WuyeCbglGtbServiceImpl extends CommonServiceImpl implements WuyeCbglGtbServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(WuyeCbglGtbEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(WuyeCbglGtbEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(WuyeCbglGtbEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(WuyeCbglGtbEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,WuyeCbglGtbEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("wuye_cbgl_gtb",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
