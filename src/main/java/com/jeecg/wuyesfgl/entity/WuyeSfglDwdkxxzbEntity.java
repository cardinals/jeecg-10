 ...
 */
@Entity
@Table(name = "wuye_sfgl_dwdkxxzb", schema = "")
@SuppressWarnings("serial")
public class WuyeSfglDwdkxxzbEntity implements java.io.Serializable {
	/**主键*/
	...
	/**是否已经导入*/
    @Excel(name="是否已经导入",width=15)
		
	private java.lang.String sfyjdr;
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  是否已经导入
	 */
	@Column(name ="SFYJDR",nullable=true,length=32)
	public java.lang.String getSfyjdr(){
		return this.sfyjdr;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  是否已经导入
	 */
	public void setSfyjdr(java.lang.String sfyjdr){
		this.sfyjdr = sfyjdr;
	}
}
