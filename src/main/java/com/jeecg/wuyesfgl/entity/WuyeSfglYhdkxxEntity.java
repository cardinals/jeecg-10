 ...
 */
@Entity
@Table(name = "wuye_sfgl_yhdkxx", schema = "")
@SuppressWarnings("serial")
public class WuyeSfglYhdkxxEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="SSJE",nullable=true)
	 ...
	 */
	@Column(name ="ZH",nullable=true,length=32)
	 ...
	 */
	@Column(name ="TJJE",nullable=true)
	 ...
	 */
	@Column(name ="SJKKE",nullable=true)
	 ...
	 */
	@Column(name ="ZT",nullable=true,length=10)
	 ...
	 */
	@Column(name ="XYXX",nullable=true,length=302)
	...
	public String toString() {
		return "WuyeSfglYhdkxxEntity [id=" + id + ", zhxm=" + zhxm + ", ssje=" + ssje + ", zh=" + zh + ", tjje=" + tjje
				+ ", sjkke=" + sjkke + ", jyrq=" + jyrq + ", zt=" + zt + ", xyxx=" + xyxx + ", year=" + year
				+ ", month=" + month + ", yhbm=" + yhbm + "]";
	}
