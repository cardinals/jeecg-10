...
public class WuyeSfglSfxmszPageEntity implements java.io.Serializable {
	/**主键*/
	...
	public String toString() {
		return "WuyeSfglSfxmszPageEntity [id=" + id + ", createName=" + createName + ", createBy=" + createBy
				...
				+ ", bpmStatus=" + bpmStatus + ", glqid=" + glqid + ", glqmc=" + glqmc + ", xmdm=" + xmdm + ", xmmc="
