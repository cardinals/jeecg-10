 ...
 */
@Entity
@Table(name = "wuye_sfgl_ysfyjszb", schema = "")
@SuppressWarnings("serial")
public class WuyeSfglYsfyjszbEntity implements java.io.Serializable {
	/**主键*/
	...
	/**算费范围*/
    @Excel(name="算费范围",width=15)
		
	private java.lang.String sffw;
    /**算费范围名称*/
    @Excel(name="算费范围名称",width=15)
		
	private java.lang.String sffwmc;
	/**计费年度*/
    @Excel(name="计费年度",width=15,dicCode="year")
		
	private java.lang.String jfnd;
	/**计费月份*/
    @Excel(name="计费月份",width=15,dicCode="months")
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  算费范围
	 */
	@Column(name ="SFFW",nullable=true,length=32)
	public java.lang.String getSffw(){
		return this.sffw;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  算费范围
	 */
	public void setSffw(java.lang.String sffw){
		this.sffw = sffw;
	}
	/**
	 *方法: 取得java.lang.String
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  算费范围名称
	 */
	@Column(name ="SFFWMC",nullable=true,length=32)
	public java.lang.String getSffwmc(){
		return this.sffwmc;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  算费范围名称
	 */
	public void setSffwmc(java.lang.String sffwmc){
		this.sffwmc = sffwmc;
	}
}
