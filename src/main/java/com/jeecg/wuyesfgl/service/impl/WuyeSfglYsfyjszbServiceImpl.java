...
@Service("wuyeSfglYsfyjszbService")
@Transactional
public class WuyeSfglYsfyjszbServiceImpl extends CommonServiceImpl implements WuyeSfglYsfyjszbServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(WuyeSfglYsfyjszbEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(WuyeSfglYsfyjszbEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(WuyeSfglYsfyjszbEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(WuyeSfglYsfyjszbEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,WuyeSfglYsfyjszbEntity t){
 		...
 		sql  = sql.replace("#{sffw}",String.valueOf(t.getSffw()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("wuye_sfgl_ysfyjszb",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
