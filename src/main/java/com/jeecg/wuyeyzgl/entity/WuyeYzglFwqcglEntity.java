 ...
 * @date 2018-03-16 14:19:30
 * @version V1.0   
 *
 */
@Entity
@Table(name = "wuye_yzgl_fwqcgl", schema = "")
@SuppressWarnings("serial")
public class WuyeYzglFwqcglEntity implements java.io.Serializable {
	/**主键*/
	...
	/**迁出房间id*/
    @Excel(name="迁出房间id",width=15)
		
	private java.lang.Integer fjid;
	/**迁出房间编号*/
    @Excel(name="迁出房间编号",width=15)
		
	private java.lang.String fjbh;
	/**迁出日期*/
    @Excel(name="迁出日期",width=15,format = "yyyy-MM-dd")
		
	private java.util.Date rzrq;
	/**迁出后收费服务对象*/
    @Excel(name="迁出后收费服务对象",width=15,dicCode="sfdx")
	...
	/**迁出后房间状态*/
    @Excel(name="迁出后房间状态",width=15,dicCode="fwzt")
	 ...
	 *@return: java.lang.Integer  迁出房间id
	 */
	 ...
	 *@param: java.lang.Integer  迁出房间id
	 */
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  迁出房间编号
	 */
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  迁出后收费服务对象
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  迁出后收费服务对象
	 */
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  迁出后房间状态
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  迁出后房间状态
	 */
